...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var collection: UICollectionView! {
        didSet {
            ...
            l.itemSize = CGSize(width: UIScreen.main.bounds.width - 20, height: 314)
            l.minimumLineSpacing = 2
//            l.minimumInteritemSpacing = 4
            l.scrollDirection = .vertical
            collection.contentInset = UIEdgeInsets(top: 2, left: 10, bottom: 10, right: 10)
    ...
    @objc func longPressAction(_ press: UILongPressGestureRecognizer) {
        ...
        messageDataSource.resetDefaultStatus(collection: collection)
...
extension ViewController: MNCloudLiveCardCellDelegate {
    ...
    func didSelect(cell: MNCloudLiveCardCell, at item: LiveCardItem?, with tag: Int) {
        ...
        case .second:
            ...
            messageDataSource.dataUpToDate = { controlData in
